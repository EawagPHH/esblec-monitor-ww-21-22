...
levels(reads_coli$X2)=list("TEM.1"="C0aT","TEM.2"= "C0bT","OXA-51.1"="C1aT", "OXA-51.2"="C1bT","SHV.1"="C2aT", "SHV.2"="C2bT", "CMY.1"="C3aT","CMY.2"="C3bT","PDC.1"="C4aT","PDC.2"= "C4bT", "CTX-M1.1"="C5aT", "CTX-M1.2"="C5bT", "ADC.1"="C6aT", "ADC.2"= "C6bT", "ACT/MIR.1"="C7aT","ACT/MIR.2"="C7bT",
                           "CTX-M9.1"= "C8aT", "CTX-M9.2"="C8bT", "IMP.1"="C9aT", "IMP.2"="C9bT", "VIM.1"="C10aT", "VIM.2"= "C10bT", "OXA-213.1"="C12aT",
                           "OXA-213.2"="C12bT", "GES.1"="C13aT", "GES.2"="C13bT", "CMY,FOX,MOX.1"="C14aT", "CMY,FOX,MOX.2"="C14bT", "CARB.1"="C15aT", "CARB.2"="C15bT",
                           "CTX-M2.1"="C18aT", "CTX-M2.2"="C18bT","OXA-48.1"="C20aT", "OXA-48.2"="C20bT","CTX-M8 and 25.1"="C27aT","CTX-M8 and 25.2"="C27bT")
...
levels(reads_coli$X3) = list("TEM" ="TEM.1","TEM" ="TEM.2","OXA-51"="OXA-51.1", "OXA-51"="OXA-51.2", "SHV"="SHV.1", "SHV"="SHV.2", "CMY"="CMY.1","CMY"="CMY.2",
                     "PDC"="PDC.1","PDC"="PDC.2", "CTX-M1"="CTX-M1.1", "CTX-M1"="CTX-M1.2", "ADC"="ADC.1", "ADC"="ADC.2", "ACT/MIR"="ACT/MIR.1","ACT/MIR"="ACT/MIR.2",
                     "CTX-M9"="CTX-M9.1", "CTX-M9"="CTX-M9.2", "IMP"="IMP.1", "IMP"="IMP.2", "VIM"="VIM.1","VIM"= "VIM.2","OXA-213"= "OXA-213.1",
                          "OXA-213"="OXA-213.2","GES"="GES.1","GES"="GES.2","CMY,FOX,MOX"="CMY,FOX,MOX.1","CMY,FOX,MOX"="CMY,FOX,MOX.2","CARB"="CARB.1", "CARB"="CARB.2",
                         "CTX-M2"="CTX-M2.1","CTX-M2"="CTX-M2.2","OXA-48"="OXA-48.1","OXA-48"="OXA-48.2","CTX-M8 and 25"="CTX-M8 and 25.1","CTX-M8 and 25"="CTX-M8 and 25.2")
...
levels(reads_coli$Month)=list("November 2021" = "November", "December 2021"="December", "January 2022" = "January",
                              "February 2022" = "February", "March 2022"="March", "April 2022"="April","May 2022"="May", 
                              "June 2022"="June", "July 2022"="July", "2nd August 2022"="August2nd", "30th August 2022"="August30th", 
                              "September 2022"="September", "October 2022"="October")
